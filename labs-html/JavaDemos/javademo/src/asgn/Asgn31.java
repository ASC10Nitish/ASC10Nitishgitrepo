...
public class Asgn31 {
    ...
    public Asgn31(String movieName, String producedBy) {
    ...
    public Asgn31(String movieName, String producedBy, String directedBy, int duration, int year, String category) {
    ...
    public static void main(String[] args) {
        Asgn31 movie = new Asgn31("Inception", "Christopher Nolan");
        movie.displayDetails();

        Asgn31 anotherMovie = new Asgn31("The Dark Knight", "Warner Bros", "Christopher Nolan", 152, 2008, "Action");
